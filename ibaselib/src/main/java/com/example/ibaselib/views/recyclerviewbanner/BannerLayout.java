...
import com.example.ibaselib.views.recyclerviewbanner.layoutmanager.BannerLayoutManager;
import com.example.ibaselib.views.recyclerviewbanner.layoutmanager.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    private Drawable selectedDrawable;                     // 选中的指示器
    private Drawable unselectedDrawable;                   // 未选中的指示器;
...
//            selectedDrawable = new LayerDrawable(new Drawable[]{selectedGradientDrawable});
            ...
            selectedDrawable = getResources().getDrawable(a.getResourceId(R.styleable.BannerLayout_selectedDrawable, R.drawable.indicator_selected));
        }
...
//            unselectedDrawable = new LayerDrawable(new Drawable[]{unSelectedGradientDrawable});
            ...
            unselectedDrawable = getResources().getDrawable(a.getResourceId(R.styleable.BannerLayout_unselectedDrawable, R.drawable.indicator_unselected));
        }
...
//        int gravity = GravityCompat.START;
        ...
        int marginLeft = dp2px(12);
        int marginRight = dp2px(12);
    ...
    protected class IndicatorAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            bannerPoint.setImageDrawable(currentPosition == position ? selectedDrawable : unselectedDrawable);
