...
import com.example.ibaselib.views.marquee.util.AnimationListenerAdapter;
import com.example.ibaselib.views.marquee.util.OnItemClickListener;
import com.example.ibaselib.utils.ScreenUtil;
 ...
 *
 *    使用方法 ：  E  == 实体类
 *       MarqueeFactory<View, E> marqueeFactory = new MarqeeModel(this);
    ...
    private final OnClickListener onClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (onItemClickListener != null) {
                if (factory == null || ScreenUtil.isEmpty(factory.getData()) || getChildCount() == 0) {
